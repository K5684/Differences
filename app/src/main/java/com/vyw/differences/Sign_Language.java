...
import com.vyw.differences.processing.DetectionMethod;
import com.vyw.differences.processing.DownSamplingFrameProcessor;
import com.vyw.differences.processing.IFrameProcessor;
import com.vyw.differences.processing.MainFrameProcessor;
import com.vyw.differences.processing.ResizingFrameProcessor;
import com.vyw.differences.processing.SizeOperation;
import com.vyw.differences.processing.postprocessing.IFramePostProcessor;
import com.vyw.differences.processing.postprocessing.OutputFramePostProcessor;
import com.vyw.differences.processing.postprocessing.UpScalingFramePostProcessor;
import com.vyw.differences.processing.preprocessing.CameraFrameAdapter;
import com.vyw.differences.processing.preprocessing.IFramePreProcessor;
import com.vyw.differences.processing.preprocessing.InputFramePreProcessor;
import com.vyw.differences.rendering.IRenderer;
import com.vyw.differences.rendering.MainRenderer;
import com.vyw.differences.svm.FrameClassifier;
...
public class Sign_Language extends Activity implements CvCameraViewListener2 {
