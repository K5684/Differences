...
public class BtDeviceListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BtDeviceListAdapter(Context context, List<Object> deviceList) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        final BtDeviceInfoModel deviceInfoModel = (BtDeviceInfoModel) deviceList.get(position);
        ...
        itemHolder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context,Arduino_activity.class);
